...
from sqlalchemy.orm import sessionmaker                               # Importamos el 'sessionmaket' de la libreria 'sqlalchemy.orm', ORM lo habilitmos en la siguiente linea de abajo
...
engine = create_engine('sqlite:///newspapers.db')                     # Acá le digo a 'sqlalchemy' que quiero utlizar 'sqllite', ya viene instalado dentro de la distribución de Python
