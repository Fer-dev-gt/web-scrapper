...
import re
import nltk
from   nltk.corpus import stopwords                                                                           # Los 'Stopwords' son palabras que no nos aportan información revelante, Ej: 'el', 'la', 'y' etc. que se usan mucho en nuestro idioma pero que no sirver para determinar que sucede en nuestro texto
...
if __name__ == '__main__':                                                                                    # Este script automatiza (como crear recetas) para la Transformación de datos paso a paso a cualquier dataset de nociticias para que quede limpio
  ...
  nltk.download('stopwords')                                                                                  # Nos declara las 'Stopwords' que son palabras que no nos aportan valor a nuestro analisis de datos como "el, la, o, lo" 
